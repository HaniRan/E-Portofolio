...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://github.com/HaniRan",
      };
  ...
  const projectUrl = `https://haniran.com/project/${toSlug(project.Title)}`;

  return (
    <>
      <Helmet>
        <title>{project.Title} — Andi Hanifah Putri Rani</title>
        <meta
          name="description"
          content={
            project.Description
              ? project.Description.slice(0, 155)
              : `Project ${project.Title} oleh Andi Hanifah Putri Rani — Frontend Web Developer.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — Andi Hanifah Putri Rani`}
        />
        <meta
        ...
        <script type="application/ld+json">{`
          {
            ...
            "author": {
              "@type": "Person",
              "name": "Andi Hanifah Putri Rani",
              "url": "https://haniran.com"
            }
          }
        `}</script>
      </Helmet>
